        ...
        <div class="row">
            ...
            <div class="col-xl-8 ">
                <form class="multisteps_form" id="wizard" method="POST" action="">
                    ...
                    <div class="multisteps_form_panel d-block <?= $key == 0 ? '' : '' ?>">
                        <div class="form_content">
                            <div class="step_content d-flex justify-content-between pt-5 pb-2">
                                <h4>TEST DE ORIENTACIÓN VOCACIONAL</h4>
                                <span
                                    class="text-end text-uppercase"><?= 'pregunta ' . ($key + 1) . ' de ' . count($listar) ?></span>
                            </div>
                            ...
                            <div
                                class="row row-cols-1 row-cols-md-2 row-cols-lg-4 form_items radio-list justify-content-center mt-3">
                                <div class="col-6">
                                    <label id="opt_1"
                                        ...
                                        <input for="opt_1" type="radio" class="required"
                                            name="respuesta<?= $item->idpreguntas ?>" value="1">
                                    </label>
                                </div>
                                <div class="col-6">
                                    <label id="opt_2"
                                        class="step_1 d-flex flex-column bg-white text-center animate__animated animate__fadeInRight animate_50ms">
                                        <div class="step_box_icon"><img
                                                src="<?= asset('plantilla-test/') ?>/assets/images/item-img/item_0.png"
                                                alt="image-not-found">
                                        </div>
                                        <span class="step_box_text pt-2">No</span>
                                        <p class="step_box_desc">No, no me interesa</p>
                                        <input for="opt_2" type="radio"
                                            name="respuesta<?= $item->idpreguntas ?>" value="0">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form_btn pt-5 d-flex justify-content-between">
                            ...
                            <button type="button" class="js-btn-prev prev_btn text-uppercase bg-white"
                                id="prevBtn"><i class="fas fa-arrow-left"></i> anterior
                                <span>pregunta</span></button>
                            <?php endif ?>
                            <button type="<?= $item == end($listar) ? 'submit' : 'button' ?>"

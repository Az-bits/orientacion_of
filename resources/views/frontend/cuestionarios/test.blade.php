                                    ...
                                    <div class="question_title d-block justify-content-center">
                                        ...
                                        <h2 class="d-flex m-auto">
                                            ...
                                            <ol>
                                                ...
                                                <li>Examina cada ítem y responde según los siguientes criterios: Si tu
                                                    respuesta a un ítem es de tu Agrado, marca la palabra “Agrado”, si tu
                                                    respuesta es Indiferente marca la palabra “Indiferente” y si te resulta
                                                    Desagrado, marca la palabra “Desagrado”.</li>
                                        ...
                                        <div class="col-4">
                                            <label id="opt_1"
                                                ...
                                                <input for="opt_1" type="radio" class="required"
                                                    name="preguntas[{{ $item->id_area }}][{{ $item->id_pregunta }}]"
                                                    value="3">
                                            </label>
                                        </div>
                                        <div class="col-4">
